...
int main()
{
    ...
    {
        if(container[j].second=="rat")
        {
            cout<<container[j].first<<endl;
        }
    }

    for(int j=0; j<(int)container.size(); j++)
    {
        if(container[j].second=="woman"||container[j].second=="child")
        {
            cout<<container[j].first<<endl;
        }
    }
